  ...
  <div v-if="seller" class="mx-auto max-w-6xl px-4 pb-14 pt-6 sm:px-6">
    ...
    <header class="mt-6 max-w-3xl">
      <div class="flex flex-wrap items-center gap-3">
        <h1 class="font-display text-4xl font-bold uppercase leading-none sm:text-5xl">{{ seller.name }}</h1>
    ...
    <section class="mt-10" aria-labelledby="annonces-title">
      <h2 id="annonces-title" class="font-display text-2xl font-bold uppercase">
      ...
      <p v-else class="mt-5 rounded-md border border-dashed border-line bg-card px-6 py-10 text-center text-ink-soft">
